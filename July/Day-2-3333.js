//? Q . 3333 Find The Original Typed String I
...
console.log(possibleStringCount("aabbccdd", 7)); // Output: 5
console.log(possibleStringCount("aabbccdd", 8)); // Output: 1
console.log(possibleStringCount("aaabbb", 3));   // Output: 8